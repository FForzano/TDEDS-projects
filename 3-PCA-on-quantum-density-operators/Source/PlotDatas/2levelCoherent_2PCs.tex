...
\addplot [only marks, color=color0, select coords between index={0}{19}] table  {./2levelCoherent_2PCs.txt};
\addlegendentry{coherent state}
\addplot [only marks, color=color1, select coords between index={20}{45}] table  {./2levelCoherent_2PCs.txt};
