...
dataset = np.load('QDataset_v4.npy')
...
# Eigenvalues crieterion
outFile = open('Eigenvalues_dimension_criterium_4.txt', 'wt')
...
if show_plot:
    ...
    tpl.save('Eigenvalues_dimension_criterium_4.tex')
    plt.show()
...
MSE = []
Class_MSE = []
outFile = open('MSE_dimension_criterium_4.txt', 'wt')
class_outFile = open('CMSE_dimension_criterium_4.txt', 'wt')
...
dataOut = open('PlotDatas/5levelSC_2PCs.txt', 'wt')
...
dataOut = open('PlotDatas/5levelSC_3PCs.txt', 'wt')
