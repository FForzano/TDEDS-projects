...
\addplot [only marks, color=color0, select coords between index={0}{19}] table  {./5levelSC_2PCs.txt};
\addlegendentry{$\mu=1.5$, $\zeta=0.2 e^{i\pi}$}
\addplot [only marks, color=color1, select coords between index={20}{39}] table  {./5levelSC_2PCs.txt};
\addlegendentry{$\mu=1.5$, $\zeta=0.5 e^{i\pi}$}
\addplot [only marks, color=color2, select coords between index={40}{59}] table  {./5levelSC_2PCs.txt};
\addlegendentry{$\mu=2.0$, $\zeta=0.2 e^{i\pi}$}
\addplot [only marks, color=color3, select coords between index={60}{79}] table  {./5levelSC_2PCs.txt};
\addlegendentry{$\mu=2.0$, $\zeta=0.5 e^{i\pi}$}
\addplot [only marks, color=color4, select coords between index={80}{99}] table  {./5levelSC_2PCs.txt};
