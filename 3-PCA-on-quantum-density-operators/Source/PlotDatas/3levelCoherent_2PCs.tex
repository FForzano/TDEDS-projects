...
\addplot [only marks, color=color0, select coords between index={0}{19}] table  {./3levelCoherent_2PCs.txt};
\addlegendentry{coherent state: $\mu=1.5$}
\addplot [only marks, color=color1, select coords between index={20}{39}] table  {./3levelCoherent_2PCs.txt};
\addlegendentry{coherent state: $\mu=2.5$}
\addplot [only marks, color=color2, select coords between index={40}{59}] table  {./3levelCoherent_2PCs.txt};
